...
module RedmineUsersTextSearch
  module Patches
    module UsersTextSearchIssueQueryPatch
      ...
      module UsersTextSearchInstanceMethods
        ...
        def initialize_available_filters_with_user_text_search
          ...
          @available_filters.each do |field, options|
            ...
            elsif field =~ /cf_\d+/ && options[:field][:type] == 'IssueCustomField' && options[:field][:field_format] == 'user'
              options[:type] = :user
...
unless IssueQuery.included_modules.include?(RedmineUsersTextSearch::Patches::UsersTextSearchIssueQueryPatch)
  IssueQuery.send(:include, RedmineUsersTextSearch::Patches::UsersTextSearchIssueQueryPatch)
end
